...
func init() {
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦e385a54f:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→test/apps/user/IUserInterface⟧\n⟦2182bc83:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→mainhttp⟧\n",
	})
}
