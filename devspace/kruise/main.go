...
func main() {
	...
	var enableLeaderElection, enablePprof, allowPrivileged, enableStartup bool
	...
	flag.BoolVar(&enableStartup, "enable-startup", true, "Enable startup probe for controller manager.")
